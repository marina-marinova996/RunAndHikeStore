namespace RunAndHikeStore.Data.Common.Repositories
{
    using System;
    ...
    public interface IRepository : IDisposable
    {
        ...
        /// </summary>
        /// <returns>Expression tree</returns>
        IQueryable<T> AsNoTracking<T>(Expression<Func<T, bool>> search) 
            where T : class;
        ...
        /// <summary>
        /// Saves all changes in trasaction.
        /// </summary>
